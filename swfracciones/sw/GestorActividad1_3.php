...
class GestorActividad1_3 extends GestorActividad {
        ...
        $this->htmlResponderA = '
            <div id="contestar">
                ...
                <span class="respuestas">
                    <input class="bot_act" type="button"  onclick="javascript:esCorrecta('.$pos_res[0]->getEsCorrecta().','.GestorActividad1_3::$idActividad.','.$this->idAlumno.')" value="'.$pos_res[0]->getValor().'"></input>
                    <input class="bot_act" type="button" onclick="javascript:esCorrecta('.$pos_res[3]->getEsCorrecta().','.GestorActividad1_3::$idActividad.','.$this->idAlumno.')"  value="'.$pos_res[3]->getValor().'"></input>
                    <input  class="bot_act" type="button" onclick="javascript:esCorrecta('.$pos_res[1]->getEsCorrecta().','.GestorActividad1_3::$idActividad.','.$this->idAlumno.')"  value="'.$pos_res[1]->getValor().'"></input>
                    <input class="bot_act" type="button"  onclick="javascript:esCorrecta('.$pos_res[2]->getEsCorrecta().','.GestorActividad1_3::$idActividad.','.$this->idAlumno.')" value="'.$pos_res[2]->getValor().'"></input>
                </span>
            </div>';
