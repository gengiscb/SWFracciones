...
class GestorActividad1_1 extends GestorActividad {
    ...
    public function __construct($idAlumno) {
        ...
        $this->respuestas[0] = new respuestaAct11("La mitad", 300);
        $this->respuestas[1] = new respuestaAct11("Un cuarto", 150);
        $this->respuestas[2] = new respuestaAct11("Un octavo", 75);
        $this->respuestas[3] = new respuestaAct11("Tres cuartos", 450);
        $this->respuestas[4] = new respuestaAct11("Tres octavos", 225);
        $this->respuestas[5] = new respuestaAct11("Cinco octavos", 375);
