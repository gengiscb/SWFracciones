            ...
            <div class="marco_registro">            
                <div class="form_registro">
                    ...
                    <form  method="get"  action="<?php echo $_SERVER['PHP_SELF'] ?>">
                        <?php
                        echo trim($controladorServicioProfesor->actualizarProfesorC());
                        ...
                        <table id="registro" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td> Matricula:</td>    
                                <td> <input type="text" disabled name="matricula" id="matricula" size="20" maxlength="46"  value="<?php echo $profesor->getMatricula() ?>"/></td>
                            </tr>
